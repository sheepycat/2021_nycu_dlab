...
namespace eval ::optrace {
  variable script "D:/109550134/Lab10/lab10/lab10.runs/impl_1/lab10.tcl"
...
OPTRACE "add files" START { }
  add_files -quiet D:/109550134/Lab10/lab10/lab10.runs/synth_1/lab10.dcp
...
OPTRACE "Write Bitstream: pre hook" START { }
  set src_rc [catch { 
    puts "source D:/109550134/Lab10/lab10/lab10.srcs/sources_1/try.tcl"
    source D:/109550134/Lab10/lab10/lab10.srcs/sources_1/try.tcl
  } _RESULT] 
  if {$src_rc} { 
    set tool_flow [get_property -quiet TOOL_FLOW [current_project -quiet]]
    if { $tool_flow eq {SDx} } { 
      send_gid_msg -id 2 -ssname VPL_TCL -severity ERROR $_RESULT
      send_gid_msg -id 3 -ssname VPL_TCL -severity ERROR "sourcing script D:/109550134/Lab10/lab10/lab10.srcs/sources_1/try.tcl failed"
    } else {
      send_msg_id runtcl-1 status "$_RESULT"
      send_msg_id runtcl-2 status "sourcing script D:/109550134/Lab10/lab10/lab10.srcs/sources_1/try.tcl failed"
    }
    return -code error
  }
